...
import { BaseColor, BaseConfig, BaseHeight, BaseWidth } from '../base'
...
export default class Layout extends BaseConfig {
  constructor(parent: Attribute) {
    ...
    this.insertAttribute(
      new Attribute({
        ...
        options: {
          ...
          controller: new AttributeController({ type: 'string', default: "['香蕉', '葡萄']", disabled: true }),
          initialConfig: {
            data: [
    ...
    this.insertAttribute(
      new Attribute({
        name: 'boxmode',
        type: { type: 'enum', value: ['group', 'overlay'] },
        options: {
          parent,
          description: {
            type: 'string',
