    ...
    this.addChild(
      new Attribute({
        ...
        options: {
          ...
          controller: new AttributeController({ type: 'select', default: 'container', options: ['container', 'paper'] })
        }
      })
    )
    ...
    this.addChild(
      new Attribute({
        ...
        options: {
          ...
          controller: new AttributeController({ type: 'number', default: 0.5, min: 0, max: 1, step: 0.1 })
        }
      })
    )
