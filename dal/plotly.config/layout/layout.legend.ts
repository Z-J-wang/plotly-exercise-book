...
import { BaseColor, BaseOrientation, BaseText, BaseUirevision, BaseVisible } from '../base'
...
class LegendTitle extends Attribute {
  constructor(initializer: Attribute.Initializer) {
    ...
    this.addChild(
      new Attribute({
        name: 'side',
        type: { type: 'enum', value: ['top', 'left', 'top left', 'top center', 'top right'] },
        options: {
          parent: this,
          description: {
            type: 'string',
  ...
  constructor(parent: Attribute, description: Attribute.Description = { type: 'string', value: '图例样式定义。' }) {
    ...
    this.addChild(
      new Attribute({
        ...
        options: {
          parent: this,
          description: { type: 'string', value: '图例边框宽度。' },
          controller: new AttributeController({ type: 'number', default: 0, min: 0, step: 1 })
        }
      })
    )
    ...
    this.addChild(
      new Attribute({
        name: 'groupclick',
        type: { type: 'enum', value: ['toggleitem', 'togglegroup'] },
        options: {
          parent: this,
          description: {
            type: 'string',
    ...
    this.addChild(
      new Attribute({
        name: 'itemclick',
        type: { type: 'enum', value: ['toggle', 'toggleothers', false] },
        options: {
          parent: this,
          description: {
            type: 'string',
    ...
    this.addChild(
      new Attribute({
        name: 'itemsizing',
        type: { type: 'enum', value: ['trace', 'constant'] },
        options: {
          parent: this,
          description: {
            type: 'string',
    ...
    this.addChild(new LegendTitle({ options: { parent: this } }))
    ...
    this.addChild(
      new Attribute({
        name: 'traceorder',
        type: { type: 'enum', value: ['grouped', 'normal', 'reversed', 'reversed+grouped'] },
        options: {
          parent: this,
          description: {
            type: 'string',
    ...
    this.addChild(
      new BaseVisible({
        options: { parent: this, description: { type: 'string', value: '是否显示图例模块' } }
      })
    )
    ...
    this.addChild(
      new Attribute({
        name: 'xanchor',
        type: { type: 'enum', value: ['auto', 'left', 'center', 'right'] },
        options: {
          parent: this,
          description: {
            type: 'string',
    ...
    this.addChild(
      new Attribute({
        name: 'yanchor',
        type: { type: 'enum', value: ['auto', 'top', 'middle', 'bottom'] },
        options: {
          parent: this,
          description: {
            type: 'string',
