...
export default class Layout extends BaseConfig {
  constructor(parent: Attribute) {
    ...
    this.insertAttribute(
      new Attribute({
        name: 'doubleClick',
        type: { type: 'enum', value: [false, 'reset', 'autosize', 'reset+autosize'] },
        options: {
          parent,
          description: {
            type: 'string',
