...
export default class PieDomain extends Attribute {
  constructor(initializer: Attribute.Initializer) {
    ...
    this.addChild(new PieDomainColumn({ options: { parent: this } }))
    this.addChild(new PieDomainRow({ options: { parent: this } }))
    this.addChild(new PieDomainX({ options: { parent: this } }))
    this.addChild(new PieDomainY({ options: { parent: this } }))
  }
}

export class PieDomainColumn extends Attribute {
  constructor(initializer: Attribute.Initializer) {
    const defaultInitializer = {
      name: 'column',
      type: 'number',
...
export class PieDomainRow extends Attribute {
  constructor(initializer: Attribute.Initializer) {
    const defaultInitializer = {
      name: 'row',
      type: 'number',
...
export class PieDomainX extends Attribute {
  constructor(initializer: Attribute.Initializer) {
    const defaultInitializer = {
      name: 'x',
      type: 'number',
...
export class PieDomainY extends Attribute {
  constructor(initializer: Attribute.Initializer) {
    const defaultInitializer = {
      name: 'y',
      type: 'number',
