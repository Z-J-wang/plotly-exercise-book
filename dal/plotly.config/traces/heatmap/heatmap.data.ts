...
export default class HeatmapData {
  constructor(parent: Attribute) {
    parent.addChild(new HeatmapDataX({ options: { parent } }))
    parent.addChild(new HeatmapDataX0({ options: { parent } }))
    parent.addChild(new HeatmapDataDx({ options: { parent } }))
    parent.addChild(new HeatmapDataXtype({ options: { parent } }))
    parent.addChild(new HeatmapDataXgap({ options: { parent } }))
    parent.addChild(new HeatmapDataY({ options: { parent } }))
    parent.addChild(new HeatmapDataY0({ options: { parent } }))
    parent.addChild(new HeatmapDataDy({ options: { parent } }))
    parent.addChild(new HeatmapDataYtype({ options: { parent } }))
    parent.addChild(new HeatmapDataYgap({ options: { parent } }))
    parent.addChild(new HeatmapDataZ({ options: { parent } }))
    parent.addChild(new HeatmapDataTranspose({ options: { parent } }))
  }
}

export class HeatmapDataX extends Attribute {
...
export class HeatmapDataX0 extends Attribute {
  constructor(initializer: Attribute.Initializer) {
    const defaultInitializer = {
      name: 'x0',
      type: 'number',
...
export class HeatmapDataDx extends Attribute {
  constructor(initializer: Attribute.Initializer) {
    const defaultInitializer = {
      name: 'dx',
      type: 'number',
...
export class HeatmapDataXtype extends Attribute {
  constructor(initializer: Attribute.Initializer) {
    const defaultInitializer = {
      name: 'xtype',
      type: { type: 'enum', value: ['array', 'scaled'] },
      options: {
        description: {
          type: 'string',
          value:
...
export class HeatmapDataXgap extends Attribute {
  constructor(initializer: Attribute.Initializer) {
    const defaultInitializer = {
      name: 'xgap',
      type: 'number',
...
export class HeatmapDataY extends Attribute {
  constructor(initializer: Attribute.Initializer) {
    const defaultInitializer = {
      name: 'y',
      type: 'number[]',
...
export class HeatmapDataY0 extends Attribute {
  constructor(initializer: Attribute.Initializer) {
    const defaultInitializer = {
      name: 'y0',
      type: 'number',
...
export class HeatmapDataDy extends Attribute {
  constructor(initializer: Attribute.Initializer) {
    const defaultInitializer = {
      name: 'dy',
      type: 'number',
...
export class HeatmapDataYtype extends Attribute {
  constructor(initializer: Attribute.Initializer) {
    const defaultInitializer = {
      name: 'ytype',
      type: { type: 'enum', value: ['array', 'scaled'] },
...
export class HeatmapDataYgap extends Attribute {
  constructor(initializer: Attribute.Initializer) {
    const defaultInitializer = {
      name: 'ygap',
      type: 'number',
...
export class HeatmapDataZ extends Attribute {
  constructor(initializer: Attribute.Initializer) {
    const defaultInitializer = {
      name: 'z',
      type: 'number[][] | number[]',
...
export class HeatmapDataTranspose extends Attribute {
  constructor(initializer: Attribute.Initializer) {
    const defaultInitializer = {
      name: 'transpose',
      type: 'boolean',
